...
public class SensorModel extends Model {
    ...
    public SensorModel() {
        ...
        bb_main.texOffs(0, 24).addBox(-3.5F, -4.0F, -0.5F, 7.0F, 6.0F, 1.0F, 0.0F, false);
        ...
        antenna_right_r1.texOffs(48, 24).addBox(-6.9488F, -8.5F, -2.1748F, 4.0F, 6.0F, 1.0F, 0.0F, true);
        ...
        antenna_left_r1.texOffs(32, 24).addBox(2.9488F, -8.5F, -2.1748F, 4.0F, 6.0F, 1.0F, 0.0F, false);
